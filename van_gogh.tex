	...
	\section{Generation of Results}
		...
		\subsection{Results}
			\subsubsection{Van Gogh Museum Dataset}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.7\linewidth]{past_attempts/van_gogh/DCGAN_2/images/epoch537_generator}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.7\linewidth]{past_attempts/van_gogh/DCGAN_2/images/epoch1127_generator}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.7\linewidth]{past_attempts/van_gogh/DCGAN_2/images/epoch1254_generator}
				...
				That way, the scaling done would affect both dimensions equally, and therefore preserve the image.
				Unfortunately, this did not have the intended effect.
				\begin{figure}
					\centering
					\includegraphics[width=0.7\linewidth]{past_attempts/van_gogh/DCGAN_2/images/epoch1406_generator}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.7\linewidth]{past_attempts/van_gogh/DCGAN_2/images/epoch1531_generator}
